...
func assertMultiStringSetImplementation() {
	var _ container.Set = (*MultiStringSet)(nil)
}
...
var itemExistsMultiStringSet = struct{}{}
...
func CopyFromMultiStringSet(ts *MultiStringSet) *MultiStringSet {
	return &MultiStringSet{Tree: rbt.CopyFrom(ts.Tree)}
}
...
func (set *MultiStringSet) AddItem(item string) (bool, string) {
	itr := set.Tree.Insert(item, itemExistsMultiStringSet)
	if itr.IsEnd() {
		return false, item
	}
...
func (set *MultiStringSet) Add(items ...string) {
	for _, item := range items {
		set.Tree.Put(item, itemExistsMultiStringSet)
	}
}
...
func (set *MultiStringSet) Iterator() IteratorMultiStringSet {
	return IteratorMultiStringSet{Iterator: set.Tree.Iterator()}
}
...
func (set *MultiStringSet) Begin() IteratorMultiStringSet {
	return IteratorMultiStringSet{set.Tree.Begin()}
}

// End returns End Iterator
func (set *MultiStringSet) End() IteratorMultiStringSet {
	return IteratorMultiStringSet{set.Tree.End()}
}
...
func (set *MultiStringSet) LowerBound(item string) IteratorMultiStringSet {
	return IteratorMultiStringSet{set.Tree.LowerBound(item)}
}

func (set *MultiStringSet) UpperBound(item string) IteratorMultiStringSet {
	return IteratorMultiStringSet{set.Tree.UpperBound(item)}
}
