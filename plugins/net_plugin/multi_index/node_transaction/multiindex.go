...
//go:generate gotemplate -outfmt "gen_%v" "github.com/zhangsifeng92/geos/libraries/multiindex/multi_index_container" NodeTransactionIndex(ById,ByIdNode,multi_index.NodeTransactionState)
...
//go:generate gotemplate -outfmt "gen_%v" "github.com/zhangsifeng92/geos/libraries/multiindex/ordered_index" ById(NodeTransactionIndex,NodeTransactionIndexNode,ByExpiry,ByExpiryNode,multi_index.NodeTransactionState,common.TransactionIdType,ByIdFunc,ByIdCompare,false)
...
//go:generate gotemplate -outfmt "gen_%v" "github.com/zhangsifeng92/geos/libraries/multiindex/ordered_index" ByExpiry(NodeTransactionIndex,NodeTransactionIndexNode,ByBlockNum,ByBlockNumNode,multi_index.NodeTransactionState,common.TimePointSec,ByExpiryFunc,ByExpiryCompare,true)
...
//go:generate gotemplate -outfmt "gen_%v" "github.com/zhangsifeng92/geos/libraries/multiindex/ordered_index" ByBlockNum(NodeTransactionIndex,NodeTransactionIndexNode,NodeTransactionIndexBase,NodeTransactionIndexBaseNode,multi_index.NodeTransactionState,uint32,ByBlockNumFunc,ByBlockNumCompare,true)
