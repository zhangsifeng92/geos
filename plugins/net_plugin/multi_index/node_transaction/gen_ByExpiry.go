...
func (tree *ByExpiry) init(final *NodeTransactionIndex) {
	tree.final = final
...
func (node *ByExpiryNode) value() *multi_index.NodeTransactionState {
...
func (tree *ByExpiry) Insert(v multi_index.NodeTransactionState) (IteratorByExpiry, bool) {
...
func (tree *ByExpiry) insert(v multi_index.NodeTransactionState, fn *NodeTransactionIndexNode) (*ByExpiryNode, bool) {
	key := ByExpiryFunc(v)
...
func (tree *ByExpiry) modify_(iter multiindex.IteratorType, mod func(*multi_index.NodeTransactionState)) bool {
	if itr, ok := iter.(IteratorByExpiry); ok {
...
func (tree *ByExpiry) makeIterator(fn *NodeTransactionIndexNode) IteratorByExpiry {
...
func (iterator IteratorByExpiry) Value() multi_index.NodeTransactionState {
