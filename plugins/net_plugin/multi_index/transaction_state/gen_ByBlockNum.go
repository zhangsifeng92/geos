...
type ByBlockNum struct {
	super *TransactionStateIndexBase // index on the OrderedIndex, IndexBase is the last super index
...
func (tree *ByBlockNum) init(final *TransactionStateIndex) {
	tree.final = final
	tree.super = &TransactionStateIndexBase{}
...
type ByBlockNumNode struct {
	Key    uint32
	super  *TransactionStateIndexBaseNode
...
func (node *ByBlockNumNode) value() *multi_index.TransactionState {
...
func (tree *ByBlockNum) Insert(v multi_index.TransactionState) (IteratorByBlockNum, bool) {
...
func (tree *ByBlockNum) insert(v multi_index.TransactionState, fn *TransactionStateIndexNode) (*ByBlockNumNode, bool) {
...
func (tree *ByBlockNum) Modify(iter IteratorByBlockNum, mod func(*multi_index.TransactionState)) bool {
...
func (tree *ByBlockNum) modify_(iter multiindex.IteratorType, mod func(*multi_index.TransactionState)) bool {
	if itr, ok := iter.(IteratorByBlockNum); ok {
...
func (tree *ByBlockNum) Values() []multi_index.TransactionState {
...
func (tree *ByBlockNum) makeIterator(fn *TransactionStateIndexNode) IteratorByBlockNum {
...
func (iterator IteratorByBlockNum) Value() multi_index.TransactionState {
