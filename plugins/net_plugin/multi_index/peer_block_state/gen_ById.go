...
func (tree *ById) init(final *PeerBlockStateIndex) {
	tree.final = final
...
func (node *ByIdNode) value() *multi_index.PeerBlockState {
...
func (tree *ById) insert(v multi_index.PeerBlockState, fn *PeerBlockStateIndexNode) (*ByIdNode, bool) {
	key := ByIdFunc(v)
...
func (tree *ById) modify_(iter multiindex.IteratorType, mod func(*multi_index.PeerBlockState)) bool {
	if itr, ok := iter.(IteratorById); ok {
...
func (tree *ById) put(key common.BlockIdType) (*ByIdNode, bool) {
...
func (tree *ById) lookup(key common.BlockIdType) *ByIdNode {
	node := tree.Root
	for node != nil {
		compare := ByIdCompare(key, node.Key)
		switch {
...
func (tree *ById) makeIterator(fn *PeerBlockStateIndexNode) IteratorById {
