...
type ByBlockNum struct {
	super *PeerBlockStateIndexBase // index on the OrderedIndex, IndexBase is the last super index
	final *PeerBlockStateIndex     // index under the OrderedIndex, MultiIndex is the final index

	Root *ByBlockNumNode
	size int
}

func (tree *ByBlockNum) init(final *PeerBlockStateIndex) {
	tree.final = final
	tree.super = &PeerBlockStateIndexBase{}
...
type ByBlockNumNode struct {
	Key    uint32
	super  *PeerBlockStateIndexBaseNode
...
func (node *ByBlockNumNode) value() *multi_index.PeerBlockState {
...
func (tree *ByBlockNum) insert(v multi_index.PeerBlockState, fn *PeerBlockStateIndexNode) (*ByBlockNumNode, bool) {
...
func (tree *ByBlockNum) modify_(iter multiindex.IteratorType, mod func(*multi_index.PeerBlockState)) bool {
	if itr, ok := iter.(IteratorByBlockNum); ok {
...
func (tree *ByBlockNum) Values() []multi_index.PeerBlockState {
	values := make([]multi_index.PeerBlockState, tree.size)
	it := tree.Iterator()
	for i := 0; it.Next(); i++ {
		values[i] = it.Value()
	}
...
func (tree *ByBlockNum) makeIterator(fn *PeerBlockStateIndexNode) IteratorByBlockNum {
