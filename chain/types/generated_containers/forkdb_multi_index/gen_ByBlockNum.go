...
type ByBlockNum struct {
	super *ByLibBlockNum // index on the OrderedIndex, IndexBase is the last super index
...
func (tree *ByBlockNum) init(final *MultiIndex) {
	tree.final = final
	tree.super = &ByLibBlockNum{}
...
func (node *ByBlockNumNode) value() *BlockStatePtr {
...
func (tree *ByBlockNum) insert(v BlockStatePtr, fn *MultiIndexNode) (*ByBlockNumNode, bool) {
...
func (tree *ByBlockNum) modify_(iter multiindex.IteratorType, mod func(*BlockStatePtr)) bool {
	if itr, ok := iter.(IteratorByBlockNum); ok {
...
func (tree *ByBlockNum) Find(key ByBlockNumComposite) IteratorByBlockNum {
	if true {
...
func (tree *ByBlockNum) put(key ByBlockNumComposite) (*ByBlockNumNode, bool) {
...
func (tree *ByBlockNum) lookup(key ByBlockNumComposite) *ByBlockNumNode {
	node := tree.Root
	for node != nil {
		compare := ByBlockNumCompare(key, node.Key)
		switch {
...
func (tree *ByBlockNum) Keys() []ByBlockNumComposite {
	keys := make([]ByBlockNumComposite, tree.size)
	it := tree.Iterator()
	for i := 0; it.Next(); i++ {
		keys[i] = it.Key()
	}
...
func (tree *ByBlockNum) makeIterator(fn *MultiIndexNode) IteratorByBlockNum {
